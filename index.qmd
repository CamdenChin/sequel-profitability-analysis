...
```{r}
#| label: plot-of-budget-vs-income-2
#| fig-width: 8
#| fig-asp: 0.7
ggplot(final_joined_data,
       aes(x = budget, y = worlwide_gross_income, color = sequel_status)) +
